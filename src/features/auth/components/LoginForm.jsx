...
export default function LoginForm() {
  ...
  return (
    ...
    >
      ...
      {error && (
        <p className="mb-6 text-red-500 text-center font-semibold select-none flex items-center justify-center space-x-1">
      ...
      <p className="mt-8 text-center text-gray-400 text-sm">
        ...
        <Link to="/signup" className="text-teal-400 hover:text-teal-300 font-semibold underline">
          Sign Up
        </Link>
      </p>
